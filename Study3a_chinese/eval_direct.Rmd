...
+ **Type_discreteGS:conditionMany:** In "many" condition, the average difference score for GSs is 22.91 higher than the average difference scores for GSs in the "one" condition -> higher diff scores indicate wider generalization **H2b: significant -> use for power analysis?**
